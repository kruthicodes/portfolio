...
const skillChips = ["AI Automation Systems", "Apps", "Web Platforms"];
      ...
      <Container>
        ...
        >
          <div className="order-2 flex flex-col items-center text-center md:order-1 md:items-start md:text-left">
            <p className="font-display text-xl font-semibold text-muted md:text-2xl">Hello, I&apos;m</p>
            <h1 className="mt-1 font-display text-5xl font-extrabold tracking-tight text-ink md:text-7xl">Kruthika</h1>

            <div className="mt-4 flex flex-wrap items-center justify-center gap-3 md:justify-start">
              <h2 className="text-xl font-medium text-muted md:text-3xl">I build</h2>
            ...
            <p className="mt-5 max-w-3xl text-base font-medium text-muted md:text-xl">
          ...
          <div className="order-1 flex justify-center md:order-2 md:justify-start">
            <div className="relative md:-ml-6">
              <div className="relative aspect-square h-64 overflow-hidden rounded-xl border border-violet-200 bg-card shadow-sm md:h-80">
                <img src="/dp.jpg" alt="Kruthika R profile photo" className="h-full w-full object-cover object-[center_8%]" />
              </div>
            </div>
          </div>
        </motion.div>
